...
@section('content')
    <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
        ...
        <div class="space-y-1.5 sm:space-y-2">
            ...
            <div class="relative group">
                ...
                <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}"
                    class="input-glass @error('email') !border-red-500 @enderror" required autofocus>
            </div>
            @error('email')
        ...
        <div class="space-y-1.5 sm:space-y-2">
            <label for="password" class="block text-sm font-semibold text-slate-700 dark:text-slate-200">Password
                Baru</label>
        ...
        <div class="space-y-1.5 sm:space-y-2">
            ...
            <div class="relative group" x-data="{ show: false }">
                ...
                <input id="password_confirmation" :type="show ? 'text' : 'password'" name="password_confirmation"
                    class="input-glass pr-12" placeholder="Ulangi password" required>
                <button type="button" @click="show = !show"
                    class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-emerald-500 transition-colors duration-300">
                    <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
