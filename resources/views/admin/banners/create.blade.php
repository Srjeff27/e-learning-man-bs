...
@section('page-title', 'Tambah Banner Pengumuman')
...
@section('content')
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 class="text-xl font-semibold text-slate-900 mb-6">Tambah Banner Baru</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="link_text" id="link_text"
                                value="{{ old('link_text', 'Selengkapnya') }}" class="input" placeholder="Selengkapnya">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="order" id="order" value="{{ old('order', 0) }}" class="input"
                                min="0">
                        ...
                        <div class="flex items-center pt-6">
                            <input type="checkbox" name="is_active" id="is_active" value="1"
                                class="w-4 h-4 text-blue-600 rounded border-gray-300" {{ old('is_active', true) ? 'checked' : '' }}>
