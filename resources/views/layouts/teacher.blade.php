...
<body class="font-['Plus_Jakarta_Sans'] bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 antialiased selection:bg-blue-500 selection:text-white relative overflow-hidden"
    ...
    {{-- 
        ========================================================
        DEFINISI CLASS STYLING (PHP Variable untuk Kebersihan Code)
        ========================================================
    --}}
    @php
        // Style Dasar Tombol
        ...
        // Style Saat Aktif (GLOSSY BLUE EFFECT - Sama seperti Student)
    ...
    <div class="fixed inset-0 z-[-1] pointer-events-none overflow-hidden">
        <div class="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-[100px] opacity-60 mix-blend-multiply dark:mix-blend-screen animate-pulse-slow"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[100px] opacity-60 mix-blend-multiply dark:mix-blend-screen animate-pulse-slow delay-1000"></div>
    </div>
    ...
    <div class="flex h-screen overflow-hidden">
                ...
                <div class="h-24 flex items-center justify-center px-6 relative border-b border-slate-100/50 dark:border-slate-800/50">
                    <a href="{{ route('teacher.dashboard') }}" class="flex items-center gap-3 w-full group">
                        <div class="relative w-10 h-10 flex-shrink-0 transition-transform duration-500 group-hover:rotate-12">
                            <div class="absolute inset-0 bg-gradient-to-tr from-emerald-500 to-blue-500 rounded-xl blur opacity-40 group-hover:opacity-60 transition-opacity"></div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mt-1">Teacher Portal</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="p-4 border-t border-slate-100 dark:border-slate-800/50">
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak
                            ...
                            <a href="{{ route('account.settings') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-emerald-50 dark:hover:bg-slate-700 hover:text-emerald-600 dark:hover:text-emerald-400 rounded-xl transition-colors">
                            ...
                            <a href="{{ route('home') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-emerald-50 dark:hover:bg-slate-700 hover:text-emerald-600 dark:hover:text-emerald-400 rounded-xl transition-colors">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto p-6 lg:p-8 scroll-smooth">
                ...
                @if (session('error'))
                    <div class="mb-6 p-4 bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 rounded-xl flex items-center gap-3 backdrop-blur-sm">
