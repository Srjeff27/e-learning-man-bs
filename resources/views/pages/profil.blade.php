            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1">
                    ...
                    <div class="space-y-4 text-slate-600 dark:text-slate-400">
                        ...
                        @else
                            <p>
                                {{ $profile->name ?? 'SMAN 2 KAUR' }} didirikan pada tahun
                                {{ $profile->established_year ?? '1990' }} dengan visi menjadi lembaga pendidikan unggulan yang
                            ...
                            <p>
                                Dengan akreditasi {{ $profile->accreditation ?? 'A' }}, kami terus berkomitmen untuk memberikan
                                pendidikan terbaik melalui
