...
@section('content')
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-white dark:bg-slate-900 transition-colors">
        <div class="container-custom px-4">
            <div class="grid sm:grid-cols-3 gap-3 sm:gap-6 mb-10 sm:mb-16">
                <div class="glass-card p-4 sm:p-8 text-center group">
                    <div
                        class="w-10 h-10 sm:w-16 sm:h-16 mx-auto bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-6 shadow-lg group-hover:scale-110 transition-transform">
                    ...
                    <h3 class="text-sm sm:text-xl font-bold text-slate-900 dark:text-white mb-1 sm:mb-2">Alamat</h3>
                    <p class="text-slate-600 dark:text-slate-400 text-xs sm:text-base">
                        Tanjung Kemuning III<br>Kab. Kaur, Bengkulu
                    </p>
                </div>

                <div class="glass-card p-4 sm:p-8 text-center group">
                    <div
                        class="w-10 h-10 sm:w-16 sm:h-16 mx-auto bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-6 shadow-lg group-hover:scale-110 transition-transform">
                        <svg class="w-5 h-5 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                    </div>
                    <h3 class="text-sm sm:text-xl font-bold text-slate-900 dark:text-white mb-1 sm:mb-2">Telepon</h3>
                    <p class="text-slate-600 dark:text-slate-400 text-xs sm:text-base">
                        (0739) 123-4567<br class="hidden sm:block">Sen-Jum: 07:00-15:00
                    </p>
                </div>

                <div class="glass-card p-4 sm:p-8 text-center group">
                    <div
                        class="w-10 h-10 sm:w-16 sm:h-16 mx-auto bg-gradient-to-br from-indigo-500 to-purple-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-6 shadow-lg group-hover:scale-110 transition-transform">
                        <svg class="w-5 h-5 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <h3 class="text-sm sm:text-xl font-bold text-slate-900 dark:text-white mb-1 sm:mb-2">Email</h3>
                    <p class="text-slate-600 dark:text-slate-400 text-xs sm:text-base">
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-slate-50 dark:bg-slate-800 transition-colors">
        <div class="container-custom px-4">
            <div class="text-center mb-8 sm:mb-12">
                <h2 class="text-xl sm:text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mb-2 sm:mb-3">Ikuti
                    Kami</h2>
                <p class="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400">Terhubung di media sosial</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
                <a href="#"
                    class="glass-card p-4 sm:p-6 flex items-center gap-3 sm:gap-4 group hover:scale-105 transition-transform">
                    <div
                        class="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="min-w-0">
                        <div class="text-sm sm:text-base font-bold text-slate-900 dark:text-white">Facebook</div>
                        <div class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">@sman2kaur</div>
                    </div>
                </a>
                ...
                <a href="#"
                    class="glass-card p-4 sm:p-6 flex items-center gap-3 sm:gap-4 group hover:scale-105 transition-transform">
                    <div
                        class="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0">
                        <svg class="w-5 h-5 sm:w-7 sm:h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <div class="min-w-0">
                        <div class="text-sm sm:text-base font-bold text-slate-900 dark:text-white">Instagram</div>
                        <div class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">@sman2kaur.official
                        </div>
                    </div>
                </a>
                ...
                <a href="#"
                    class="glass-card p-4 sm:p-6 flex items-center gap-3 sm:gap-4 group hover:scale-105 transition-transform">
                    <div
                        class="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-red-500 to-red-600 rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0">
                        <svg class="w-5 h-5 sm:w-7 sm:h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <div class="min-w-0">
                        <div class="text-sm sm:text-base font-bold text-slate-900 dark:text-white">YouTube</div>
                        <div class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">SMAN 2 KAUR</div>
                    </div>
                </a>
            </div>
        </div>
