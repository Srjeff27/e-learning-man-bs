<nav class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg backdrop-saturate-150 shadow-lg shadow-blue-500/5 border-b border-blue-100/50 dark:border-blue-900/30 sticky top-0 z-50 transition-all duration-300"
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16 lg:h-20">
            ...
            <div class="flex items-center group">
                <a href="{{ url('/') }}"
                    ...
                    <div class="hidden sm:block">
                        <span
                            class="text-lg lg:text-xl font-bold bg-gradient-to-r from-blue-700 to-blue-900 dark:from-blue-400 dark:to-blue-200 bg-clip-text text-transparent">SMAN
                            2 KAUR</span>
                        <span class="block text-xs text-gray-600 dark:text-gray-300 -mt-1 font-medium">Sistem Informasi
                            Sekolah</span>
                    </div>
                </a>
            </div>
            ...
            <div class="flex items-center space-x-3 lg:space-x-4">
                ...
                @auth
                    <a href="{{ url('/dashboard') }}" class="hidden lg:inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 
                ...
                @else
                    <div class="hidden lg:flex items-center space-x-3">
                        ...
                        <a href="{{ route('register') }}" class="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 
                                                          text-white font-medium rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 
                                                          transition-all duration-300 transform hover:-translate-y-0.5">
                            Daftar
                        </a>
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300"
        ...
        class="lg:hidden bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl backdrop-saturate-150 border-t border-blue-100/30 dark:border-blue-900/30">
        <div class="px-4 py-6 space-y-1">
            <a href="{{ url('/') }}"
                class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                {{ request()->is('/') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
            ...
            <div class="space-y-1">
                <div class="px-4 py-2 text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider">
                    Profil</div>
                <a href="{{ url('/profil') }}"
                    class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                    {{ request()->is('profil*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                    <span class="w-1 h-4 bg-blue-400 rounded-full mr-3"></span>
                    Tentang Sekolah
                </a>
                <a href="{{ url('/visi-misi') }}"
                    class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                    {{ request()->is('visi-misi*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                    <span class="w-1 h-4 bg-blue-400 rounded-full mr-3"></span>
                    Visi & Misi
                </a>
                <a href="{{ url('/struktur-organisasi') }}"
                    class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                    {{ request()->is('struktur-organisasi*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                    <span class="w-1 h-4 bg-blue-400 rounded-full mr-3"></span>
                    Struktur Organisasi
                </a>
                <a href="{{ url('/guru-staff') }}"
                    class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                    {{ request()->is('guru-staff*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                    <span class="w-1 h-4 bg-blue-400 rounded-full mr-3"></span>
                    Guru & Staff
                </a>
            </div>
            ...
            <a href="{{ url('/berita') }}"
                class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                {{ request()->is('berita*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ url('/galeri') }}"
                class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                {{ request()->is('galeri*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ url('/kalender') }}"
                class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                {{ request()->is('kalender*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ url('/kontak') }}"
                class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300
                {{ request()->is('kontak*') ? 'bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-blue-50/30 dark:hover:bg-blue-900/10' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="pt-6 border-t border-blue-100/30 dark:border-blue-900/30 space-y-3">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-xl shadow-lg shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-0.5">
                        Dashboard
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="flex items-center justify-center px-4 py-3 text-blue-600 dark:text-blue-400 font-medium rounded-xl border-2 border-blue-200 dark:border-blue-800 transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700">
